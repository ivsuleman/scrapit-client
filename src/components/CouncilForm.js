        ...
        <form onBlur={this.handleBlur}>
          <span>
            ...
            <input
              ...
              type="text"
              name="logo"
              placeholder="Enter URL for the Council Logo"
            ...
            <input
              ...
              type="text"
              name="building_name"
              placeholder="Enter the Address: Builiding Name (if it exists)"
            ...
            <input
              ...
              type="text"
              name="town"
              placeholder="Enter the Address: Town"
            ...
            <input
              ...
              type="text"
              name="county"
              placeholder="Enter the Address: County"
              value={this.state.town}
              onChange={this.handleInput}
            />
            {"\n"}
            ...
            <input
              ...
              type="text"
              name="postcode"
              placeholder="Enter the Address: Postcode"
            ...
            <input
              ...
              type="text"
              name="email"
              placeholder="Enter the Council Email Address"
            ...
            <input
              ...
              type="text"
              name="phone"
              placeholder="Enter the Council Phone Number"
