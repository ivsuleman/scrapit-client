            ...
            <div className="landingPage">
                <div className="pane1_how">
                    <div className="pane_header">
                        ...
                        <div className="pane_title"><h1>How it works</h1></div>
                    </div>
                        ...
                        <div className="pan_content">
                            <div className="pane_row">
                                ...
                                <div className="description">
                                    <p className="pane_sub_title">Request a waste collection using the ScrapIt app</p>
                                    <p className="pane_sub_title">Provide details of the waste to be collected, selecting the location and convenient collection times.</p>
                                </div>
                            </div>
                            ...
                            <div className="pane_row">
                                ...
                                <div className="description">
                                    <p className="pane_sub_title">Meet your waste collector</p>
                                    <p className="pane_sub_title">One of our verified licenced waste collectors will confirm and collect the waste straight from your doorstep. </p>
                                </div>
                            </div>
                            <div className="pane_spacer"></div>
                            <div className="pane_row">
                                ...
                                <div className="description">
                                    <p className="pane_sub_title">Confirmation of waste disposal</p>
                                    <p className="pane_sub_title">Payment will only be taken once the waste has been disposed as expected at one of our approved sites and the waste deposit verified.</p>
                                </div>
                            </div>
